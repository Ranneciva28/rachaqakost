...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/rachaqakost.css') }}"><link rel="stylesheet" href="{{ asset('assets/rachaqakost-fixes.css') }}?v=20260818-db-export-undo"><link rel="stylesheet" href="{{ asset('assets/dashboard-waiting-list.css') }}?v=20260907"><link rel="stylesheet" href="{{ asset('assets/mobile-admin-navigation.css') }}?v=20260907">
</head>
<body>
@php($activeTab='imports')
<div class="shell">@include('partials.admin-navigation')
...
<script src="{{ asset('assets/rachaqakost.js') }}?v=20260907-mobile-nav"></script><script src="{{ asset('assets/confirm-actions.js') }}?v=20260905-3"></script></body></html>
